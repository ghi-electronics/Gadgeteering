...
FLASH::FLASH(unsigned char socketNumber)
{
	...
	this->spi = t_socket->getSPIBus()->getSPIDevice(t_socket->pins[6], new SPIConfiguration(false, 0, 0, false, true, 4000));
	this->statusLED = new digital_output(socket, socket::pins::Five, false);
}
