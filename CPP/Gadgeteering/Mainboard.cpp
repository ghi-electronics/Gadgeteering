...
GHI::Interfaces::SerialDevice* Mainboard::getNewSerialDevice(CPUPin txPin, CPUPin rxPin, int baudRate, unsigned char parity, unsigned char stopBits, unsigned char dataBits) { mainboard->panic(ERR_SERIAL_NOT_SUPPORTED); return NULL; };
GHI::Interfaces::SerialDevice* Mainboard::getNewSerialDevice(Socket* socket, Socket::Pin txPinNumber, Socket::Pin rxPinNumber, int baudRate, unsigned char parity, unsigned char stopBits, unsigned char dataBits) { mainboard->panic(ERR_SERIAL_NOT_SUPPORTED); return NULL; };
